...
if ($dbSuccess) {
	...
	$header_ID = '<a href="'.$thisScriptName.'?fieldNameToSortOn=ID">Country ID</a>';
	$header_Name = '<a href="'.$thisScriptName.'?fieldNameToSortOn=Name">Country</a>';
	$header_Town = '<a href="'.$thisScriptName.'?fieldNameToSortOn=Population">Population</a>';
